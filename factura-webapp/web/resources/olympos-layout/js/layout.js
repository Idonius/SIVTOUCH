...
function updateMenu() {
    ...
    var paramLayout = getUrlParameter('layout');

    if (paramLayout != null) {
        // var links = $('#layout-tab-menu').find("a.active");  
        $('#layout-tab-menu').find('li a').removeClass('active');
        $("#layout-tab-menu").find("[rel='" + paramLayout + "']").addClass('active');
    }
