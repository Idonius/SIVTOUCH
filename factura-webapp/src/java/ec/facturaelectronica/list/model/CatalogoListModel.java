 ...
 * @author Armando
 */
@FacesConverter(forClass = Catalogo.class, value = "CatalogoListModel")
public class CatalogoListModel implements Converter{
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String submittedValue) {
        if (submittedValue.trim().equals("")) {
            ...
            for (Catalogo obj : catalogoModel) {
                if (obj.getIdCatalogo().toString().equals(submittedValue)) {
                    return obj;
                }
            }
        }
